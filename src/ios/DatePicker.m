...
- (void)updateDatePicker:(NSMutableDictionary *)options {
  ...
  NSString *requestedLocale = [options objectForKey:@"locale"];
  NSLocale *determinedLocale = (requestedLocale) ? [NSLocale localeWithLocaleIdentifier:requestedLocale] : [NSLocale currentLocale];
  ...
  if (determinedLocale) {
    [self.datePicker setLocale:determinedLocale];
  }
}
